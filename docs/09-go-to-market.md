...
- First Indie Hackers launch post: TT-HVAC-002 ships
- First Reddit answer-author thread in `/r/HVAC` reaches 12+ upvotes
- First reply on a `builders@tradetoolset.com` application; reviewer assigns a brief
...
- TT-DENT-004 launch post on Indie Hackers + AGD newsletter sponsored slot ($1,800) sent
...
- 1 builder tool published (TT-DENT-009 — claim resubmitter)
...
8. **t+1h 30min** — Post a soft-launch ping in the Charlotte HVAC FB group's moderator DM ("TradeToolset is live at ts-hvac-002, want a free install?"); same for dental, restaurant, salon, agency, ecom moderators.
