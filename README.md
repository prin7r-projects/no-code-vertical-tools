# TradeToolset — `no-code-vertical-tools`
...
- **Brand**: TradeToolset — workshop-black canvas, persimmon accent, Inter + JetBrains Mono pair
...
|---|---|---|---|
| `TT-HVAC-002` | HVAC | Quote generator (form → branded PDF in 60s) | live |
| `TT-DENT-004` | Dental | No-show predictor (risk score + SMS reminder) | live |
| `TT-REST-007` | Restaurant | Table-turn optimizer (POS → reseat plan) | live |
| `TT-SALN-001` | Salon / spa | Rebook reminder (6-week SMS, 1-tap confirm) | live |
| `TT-AGEN-003` | Agency | Invoice chaser (Xero/FreshBooks → drafted escalations) | live |
| `TT-SAOPS-005` | SaaS-ops | Churn flag (Stripe + Posthog + inbox → Slack alert) | live |
| `TT-ECOM-006` | E-commerce | Cart-to-WhatsApp (Shopify abandoned → 9-min nudge) | live |
| `TT-ROOF-008` | Roofing | Scope-of-work emailer (photos → priced email) | draft · q3 |
